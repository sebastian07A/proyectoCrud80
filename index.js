...
//importacion del modulo fs para leer/escribir el archivo json y path para la ruta
const fs = require("fs")
...
miApp.post("/api/productos", (req, res) => {
    ...
    const nuevoProducto = {
        ...
        stock,
        categoria,
        imagen: imagen ?? "sin imagen" // Se asigna temporalmente si no llega imagen
    }
...
miApp.put("/api/productos/:id", (req, res) => {
    ...
    productos[index] = {
        ...
        stock,
        categoria,
        imagen: imagen ?? productos[index].imagen ?? "sin imagen"
    }
